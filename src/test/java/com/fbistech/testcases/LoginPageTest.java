...
//	
//	@Test(priority = 4)
//	public void verifyUserCannotLoginWithInvalidEmail() throws Exception
//	{
//		logInPage = homePage.clickOnLogInLink();
//		homePage = logInPage.validateUserLogin(prop.getProperty("invalidPhoneNo"), prop.getProperty("password"));	
//	}
//	
//	
//	
//	@Test(priority = 5)
//	public void verifyUserCannotLoginWithInvalidPwd() throws Exception
//	{
//		logInPage = homePage.clickOnLogInLink();
//		homePage = logInPage.validateUserLogin(prop.getProperty("phoneNo"), prop.getProperty("invalidPassword"));	
//	
//	}
//	
//	
